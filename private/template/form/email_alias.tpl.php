...
<tr>
	...
	<td class="field"><input name="name" value="<?php echo $email_alias->name; ?>" /> @<?=$domain->name?></td>
</tr>
<tr>
	<td class="label">Actif :</td>
	<td class="field"><input type="radio" name="actif" value="1"<?php if ($email_alias->actif) echo " checked"; ?> /> OUI <input type="radio" name="actif" value="0"<?php if (!$email_alias->actif) echo " checked"; ?> /> NON</td>
</tr>
<tr>
	<td class="label">Alias de :</td>
	<td class="field"><select name="email_id" onchange="this.form.redirect_email.value='';//this.form.redirect_email.disabled=true;"><option value="0">-- Choisir au besoin --</option><?
...
<tr>
	...
	<td class="field"><input name="redirect_email" value="<?php echo $email_alias->redirect_email; ?>" /></td>
</tr>
</table>
</div>
