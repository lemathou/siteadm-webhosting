...
<body>
	...
	<form method="post">
		<p>
			<input type="button" value="Recharger Apache"
				onclick="apache_reload()" /> <input type="button"
				value="Relancer Apache" onclick="apache_restart()" /> <input
				type="button" value="Démarrer Apache" onclick="apache_start()" /> <input
				type="button" value="Arrêter Apache" onclick="apache_stop()" />
		</p>
	</form>
	<?php } ?>
</body>
