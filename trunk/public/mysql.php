...
<body>
	...
	<form>
		<p>
			<input type="button" value="Redémarrer MySQL"
				onclick="mysql_restart()" /> <input type="button"
				value="Recharger MySQL" onclick="mysql_reload()" /> <input
				type="button" value="Recharger les privilèges MySQL"
				onclick="mysql_privileges_reload()" />
		</p>
	</form>
	<?php } ?>
</body>
