...
# Default-Stop:
# Short-Description: starts php5-siteadm
# Description:       Starts PHP5 FastCGI Process Manager Daemon for Siteadm
### END INIT INFO
...
DAEMON_ARGS="--fpm-config /home/siteadm_admin/conf/php/php5-fpm-siteadm.conf"
PIDFILE=/home/siteadm_admin/conf/php/php5-fpm.pid
TIMEOUT=30
