...
<form method="post" action="?id=<?php echo $ftp->id; ?>" class="edit">
	...
	<table>
		...
		<tr>
			<td>&nbsp;</td>
			<td><input class="submit" type="submit" name="_password_update"
				value="Changer de mot de passe" /></td>
...
<form method="post"
	action="<?php echo ($ftp->id?"?id=$ftp->id":"?add") ?>" class="edit">
	<input type="hidden" name="account_id"
		value="<?php echo $ftp->account_id; ?>" />
	<table>
		<tr>
		...
		<tr>
			...
			<td><?php echo $account->name; ?>_<input name="username"
				value="<?php echo $ftp->username; ?>" /></td>
		</tr>
		<?php if (!$ftp->id) { ?>
		<tr>
		...
		<tr>
			...
			?>
			</select> / <input name="folder" value="<?php echo $ftp->folder; ?>" />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><input class="submit" type="submit"
				name="<?php if (!$ftp->id) echo "_insert"; else echo "_update"; ?>"
				value="<?php if (!$ftp->id) echo "Ajouter"; else echo "Mettre à jour"; ?>" />
			</td>
