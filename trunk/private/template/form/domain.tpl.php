	...
	<div style="width: 600px;" class="cadre">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				...
				<?php if ($domain->id) {?>
					onclick="if (false) alert('Attention !')" <?php }; ?>><?php
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			...
			<tr>
				...
				<td class="field"><input name="name"
					value="<?php echo $domain->name; ?>" />
				</td>
			</tr>
			<?php } ?>
			<tr>
				<td class="label">Prise en charge des emails</td>
				<td class="field"><input type="radio" name="email_actif" value="1"
				<?php if ($domain->email_actif) echo " checked"; ?> /> OUI <input
					type="radio" name="email_actif" value="0"
					<?php if (!$domain->email_actif) echo " checked"; ?> /> NON</td>
			</tr>
		</table>
	</div>
