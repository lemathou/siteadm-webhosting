	...
	<div style="width: 600px;" class="cadre">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				...
				<?php if ($db->id) { ?>
				<td class="field"><?php echo $db->dbname; ?>
				</td>
				<?php } else { ?>
				<td class="field"><input name="dbname"
					value="<?php echo $db->dbname; ?>" />
				</td>
				<?php } ?>
			</tr>
			<tr>
				...
				<?php if ($db->id) { ?>
				<td class="field"><?php echo $db->username; ?>
				</td>
				<?php } else { ?>
				<td class="field"><input name="username"
					value="<?php echo $db->username; ?>" />
				</td>
				<?php } ?>
			</tr>
			<tr>
				<td class="label">Password :</td>
				<td class="field"><input name="password"
					value="<?php echo $db->password; ?>" />
				</td>
			</tr>
			<tr>
