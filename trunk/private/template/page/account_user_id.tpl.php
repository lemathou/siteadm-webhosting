...
<form method="post" action="account.php?id=<?=$account->id?>"
	...
	<table cellspacing="2" cellpadding="2" border="0"
		...
		<tr>
			...
			<td class="field"><?=$account->id?><input type="hidden" name="id"
				value="<?=$account->id?>" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="field"><?php if ($account->actif) echo "ACTIF"; else echo "INACTIF"; ?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="field"><input name="email" value="<?=$account->email?>"
				size="32" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="field"><input name="prenom" value="<?=$account->prenom?>" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="field"><input name="societe"
				value="<?=$account->societe?>" /></td>
		</tr>
		<tr>
			<td class="label">Offre</td>
			<td class="field"><?php echo $offre_list[$account->offre_id][name]; ?>
			</td>
		</tr>
		<tr>
	...
	<p>
		<input type="submit" name="_account_update" value="Mettre à jour" />
	</p>
</form>
