	...
	<table width="100%" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td><table width="100%" cellspacing="0" cellpadding="0">
					<tr>
						<td>Stockage publique (sites, FTP, etc.) :</td>
						<td align="right"><?php echo $account->root_foldersize($account->public_folder()); ?>
						</td>
					</tr>
					<tr>
						<td>Stockage privé sécurisé (clefs, etc.) :</td>
						<td align="right"><?php echo $account->root_foldersize($account->private_folder()); ?>
						</td>
					</tr>
					<tr>
						<td>Emails :</td>
						<td align="right"><?php echo $account->root_foldersize($account->email_folder()); ?>
						</td>
					</tr>
					<tr>
						<td>Backups :</td>
						<td align="right"><?php echo $account->root_foldersize($account->backup_folder()); ?>
						</td>
					</tr>
					<tr>
						<td>Logs & stats :</td>
						<td align="right"><?php echo $account->root_foldersize($account->log_folder()); ?>
						</td>
					</tr>
					<tr>
						<td>Fichiers de configuration :</td>
						<td align="right"><?php echo $account->root_foldersize($account->conf_folder()); ?>
						</td>
					</tr>
					<tr>
						<td>Cookies :</td>
						<td align="right"><?php echo $account->root_foldersize($account->session_folder()); ?>
						</td>
					</tr>
					<tr>
						<td>Fichies temporaire :</td>
						<td align="right"><?php echo $account->root_foldersize($account->tmp_folder()); ?>
						</td>
					</tr>
					<tr>
						<td><b>Utilisation totale / Quota :</b></td>
						<td><?php echo $account->root_foldersize($account->folder()); ?></td>
						<td><?php
