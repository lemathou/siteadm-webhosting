...
<form method="post">
	<h3>
		<?php echo $fullpath; ?>
		<input name="file_choose" type="button" value="Choose"
			onclick="path_choose('<?php echo $opt["file_choose_name"]; ?>', '<?php echo $fullpath; ?>')" />
	</h3>
	<p>
		<a
			href="<?php echo "?path=$path&file_choose_name=$opt[file_choose_name]&hidden=".((!$opt["hidden"]) ? "1" : "0"); ?>">Hidden
			files</a>
	</p>
	...
	<table cellspacing="2" cellpadding="0" width="100%">
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><a
				href="?path=<?php echo $path_parent; ?>&file_choose_name=<?php echo $opt["file_choose_name"]; ?>&hidden=<?php echo $opt["hidden"]; ?>"
...
?>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td><input id="folder_create"
				onchange="if (this.value) this.name=this.id;" /></td>
